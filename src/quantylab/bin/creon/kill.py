...
output = subprocess.check_output(
    "WMIC PROCESS get Caption,Commandline,Processid /format:list", shell=True
)
...
for p in output.split("\n\n\n"):
    ...
    for line in p.split("\n"):
        ...
        if k == "Caption":
            ...
            pid = v
    if (
        (name == "python.exe" and "quantylab\manage.py runserver" in cmd)
        or (name == "python.exe" and "quantylab\creon\pub.py" in cmd)
